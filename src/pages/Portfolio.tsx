...
const companies: Company[] = [
  { name: "90 Seconds", fund: "Fund I", sector: "Marketing Tools", model: "B2B", status: "Active", description: "The world's leading cloud video production platform, enabling brands to create professional content globally.", logoUrl: "https://qualgro.com/wp-content/uploads/elementor/thumbs/90-Seconds-p8mvjzwkhmzs92jgwkblgafks3d3mlrpiikugcldp0.png" },
  { name: "Accredify", fund: "Fund II", sector: "Education", model: "B2B", status: "Active", description: "Digital credentials platform enabling institutions to issue verifiable, tamper-proof certificates.", logoUrl: "https://qualgro.com/wp-content/uploads/elementor/thumbs/Full-Logo-Colour-on-white-e1627527599702-1-e1637145660235-pghfjam3tt9v078zx9mo7ow2672hmwu555oerr3ul0.png" },
  { name: "Appier", fund: "Fund I", sector: "Marketing Tools", model: "B2B", status: "Exited", description: "AI-powered marketing platform providing predictive analytics and cross-screen solutions. IPO on Tokyo Stock Exchange.", logoUrl: "https://qualgro.com/wp-content/uploads/elementor/thumbs/Appier-p8mumgzsqd3m5r8ko2mmiqzq1clt38ocwkxe92avmc.png" },
  { name: "Bizzi", fund: "Fund II", sector: "SME / Enterprise Tools", model: "B2B", status: "Active", description: "Vietnam's leading automated invoice processing and e-invoice platform for enterprises.", logoUrl: "https://qualgro.com/wp-content/uploads/elementor/thumbs/Bizzi-Logo-2-p8mv3hukicekfiid9fjdogc9ckp4hw9cku9z5h26xg.png" },
  { name: "Brighte", fund: "Fund II", sector: "FinTech", model: "B2B2C", status: "Active", description: "Australia's leading buy-now-pay-later platform for sustainable home improvements and solar energy.", logoUrl: "https://qualgro.com/wp-content/uploads/elementor/thumbs/Brighte-p8muqdzl7igmj9jrsrknwrev55av5u83fys88khtp0.png" },
  { name: "Convosight", fund: "Fund II", sector: "Consumer & Retail", model: "B2B", status: "Active", description: "Community commerce platform enabling brands to leverage online communities for authentic engagement.", logoUrl: "https://qualgro.com/wp-content/uploads/elementor/thumbs/convosight-png-papysn7s4i5btwoi17y5trti6pztnk44n77ekc8as4.png" },
  { name: "Curious Thing", fund: "Fund I", sector: "Service Platform", model: "B2B", status: "Exited", description: "Voice AI assistant platform automating phone-based customer interactions for businesses.", logoUrl: "https://qualgro.com/wp-content/uploads/elementor/thumbs/Curious-Thing-p8mvjnoo0sj22517vx1g1vil231bujf74u3j7r3hxw.png" },
  { name: "DataRepublic", fund: "Fund I", sector: "Service Platform", model: "B2B", status: "Exited", description: "Secure data exchange platform enabling organizations to share and monetize data assets safely." },
  { name: "Edmicro", fund: "Fund II", sector: "Education", model: "B2B", status: "Active", description: "Vietnam's leading edtech platform providing digital learning solutions to schools and students.", logoUrl: "https://qualgro.com/wp-content/uploads/elementor/thumbs/Edmicro-Logo-transparent2-p8mvuock4vm25l11joi0a3f3qoq82t5xbdefqird04.png" },
  { name: "EngageRocket", fund: "Fund II", sector: "SME / Enterprise Tools", model: "B2B", status: "Active", description: "People analytics platform providing HR teams with real-time employee engagement and performance insights.", logoUrl: "https://qualgro.com/wp-content/uploads/elementor/thumbs/Engage-Rocket-p8mulh9xinqpwkoggn6sw007gphuyqqk3o4y0jru6s.png" },
  ...
  { name: "Eyeota", fund: "Fund I", sector: "Marketing Tools", model: "B2B", status: "Exited", description: "Global audience data marketplace enabling marketers to reach audiences across digital channels.", logoUrl: "https://qualgro.com/wp-content/uploads/elementor/thumbs/Eyeota-p8muplsfihe0uyoqdfdutyj1bl5uqx45c37nu9nmvo.png" },
  { name: "Fluent", fund: "Fund I", sector: "Marketing Tools", model: "B2B", status: "Active", description: "Performance marketing and data-driven customer acquisition platform serving global brands." },
  { name: "Funding Societies", fund: "Fund I", sector: "FinTech", model: "B2B", status: "Active", description: "Southeast Asia's largest SME digital financing platform, providing business loans to small and medium enterprises.", logoUrl: "https://qualgro.com/wp-content/uploads/elementor/thumbs/Funding-Societies-p8mul8tdt5f5030qu1j5rk5248nk1gsz2i9kp24dqs.png" },
  ...
  { name: "Hevo", fund: "Fund II", sector: "SME / Enterprise Tools", model: "B2B", status: "Active", description: "Market-leading automated, no-code data pipeline platform for modern data teams.", logoUrl: "https://qualgro.com/wp-content/uploads/elementor/thumbs/hevo-logo-p8muqmg4x0s7fr7hfd8b17a0hm56345oh4nlk25a50.png" },
  { name: "Medo", fund: "Fund II", sector: "Service Platform", model: "B2B", status: "Exited", description: "AI-powered clinical decision support platform for medical imaging and diagnostics.", logoUrl: "https://qualgro.com/wp-content/uploads/elementor/thumbs/medo-ai-e1628745560872-pbql8bvrw6crvr12g5r60z6dcdj5sonkmmoow3cnf8.png" },
  { name: "Mobikon", fund: "Fund I", sector: "Consumer & Retail", model: "B2B", status: "Exited", description: "AI-powered customer engagement and analytics platform for the F&B and retail industries." },
  { name: "NoBroker", fund: "Fund I", sector: "Consumer & Retail", model: "B2C", status: "Active", description: "India's largest proptech platform eliminating brokerage, connecting property owners and tenants directly.", logoUrl: "https://qualgro.com/wp-content/uploads/elementor/thumbs/NO-Broker-p8mvf7w3qygb8fhbszyv9zu82kwxhzstuv6zmpofbo.png" },
  { name: "Nura", fund: "Fund I", sector: "Robotics / Hardware", model: "B2C", status: "Exited", description: "Audio technology company creating personalized sound experiences through self-learning headphones.", logoUrl: "https://qualgro.com/wp-content/uploads/elementor/thumbs/Nura-p8mvcz1zf7dnhyqqx10ybk8kzfzd40vwvr38cx0a6s.png" },
  { name: "OpenAgent", fund: "Fund I", sector: "Consumer & Retail", model: "B2B2C", status: "Active", description: "Australia's leading platform matching home sellers with top-performing real estate agents using data-driven insights." },
  { name: "Oway", fund: "Fund I", sector: "Consumer & Retail", model: "B2C", status: "Active", description: "Myanmar's leading travel and lifestyle platform offering flights, hotels, and experiences across Southeast Asia.", logoUrl: "https://qualgro.com/wp-content/uploads/elementor/thumbs/Qway-p8muvz51u23zjtfl66itqcni9lrex2enjme4xs7kpg.png" },
  ...
  { name: "Pazzi", fund: "Fund II", sector: "Robotics / Hardware", model: "B2B", status: "Exited", description: "Robotics company automating food preparation with fully autonomous pizza-making robots." },
  { name: "Ralali", fund: "Fund I", sector: "Consumer & Retail", model: "B2C", status: "Active", description: "Indonesia's leading B2B e-commerce marketplace connecting manufacturers and distributors with SME buyers.", logoUrl: "https://qualgro.com/wp-content/uploads/elementor/thumbs/Ralali-nO-HI-RES-p8mvmqlmf8qw44k3w8zf83iz5jun2tniw32tuej1jo.png" },
  { name: "ShopBack", fund: "Fund I", sector: "Consumer & Retail", model: "B2C", status: "Active", description: "Asia-Pacific's leading shopping and rewards platform, helping millions save through cashback across 3,000+ merchants.", logoUrl: "https://qualgro.com/wp-content/uploads/elementor/thumbs/shopback_logo_v2-min-q974uas55cu3a8qzgvygcczu23rxgxmf8l8biboxw4.png" },
  { name: "Sirion", fund: "Fund I", sector: "SME / Enterprise Tools", model: "B2B", status: "Active", description: "AI-powered contract lifecycle management platform trusted by Fortune 500 enterprises worldwide.", logoUrl: "https://qualgro.com/wp-content/uploads/elementor/thumbs/Sirion-Labs-p8muslvvcfhzy4bpu83yap91mwd2c41a2y8i137d04.png" },
  ...
  { name: "Vend", fund: "Fund II", sector: "Consumer & Retail", model: "B2C", status: "Exited", description: "Cloud-based point-of-sale and retail management platform acquired by Lightspeed Commerce.", logoUrl: "https://qualgro.com/wp-content/uploads/elementor/thumbs/Vend-p8mub1ahkxg0wjulg4o16mvtukz1ft9xbz6q1v9bbo.png" },
  { name: "Wavecell", fund: "Fund I", sector: "Service Platform", model: "B2B", status: "Exited", description: "Cloud communications platform adding real-time messaging, voice, and video capabilities to any application.", logoUrl: "https://qualgro.com/wp-content/uploads/elementor/thumbs/wavecell-logo-1-p8mv1crsxxh1zhmbri7yzzsgmz90yprcy8s5ss8h3o.png" },
];
